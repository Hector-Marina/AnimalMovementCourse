...
UWBdata$Time=as.POSIXct(UWBdata$Time, format = "%d-%b-%Y %H:%M:%S",  tz = "UTC")
...
PS. If the time conversion command did not work (`as.POSIXct()`) try running this command right before it ('Sys.setlocale("LC_TIME", "C")').
```
